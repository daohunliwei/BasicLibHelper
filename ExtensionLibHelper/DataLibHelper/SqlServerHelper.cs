...
namespace BaseLib.Common.DataHelper
{
    /// <summary>
    ...
    public  class SqlServerHelper
    {
        ...
        public  void ExcuteString(string strCommand)
        {
            if (strCommand != "")
            {
        ...
        public  string ExecuteString(string connectionString, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            // Pass through the call providing null for the set of SqlParameters
            return Convert.ToString(ExecuteScalar(connectionString,commandType, commandText, commandParameters));
        }
        ...
        {
            if (_ConnectionStr == null || _ConnectionStr.Length == 0) throw new ArgumentNullException("connectionString");
        ...
        public  int ExecuteNonQuery(SqlConnection connection, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            ...
            if (mustCloseConnection)
                connection.Close();
            //if (DateTime.Now.Subtract(timeStart).TotalMilliseconds > 600)//测试数据库读取时间600ms
            //{
            //    LogHelper.LogHelper.WriteLog("WRN", "DBO", "SQLHelper", "ExecuteNonQuery", "数据库查询时间超过600ms。耗时：" + DateTime.Now.Subtract(timeStart).TotalMilliseconds + "ms", null);
            //}
            return retval;
        }
        ...
        {
            //if( connectionString == null || connectionString.Length == 0 ) throw new ArgumentNullException( "connectionString" );
            if (connectionString == null||connectionString=="") connectionString = _ConnectionStr;
            // Create & open a SqlConnection, and dispose of it after we are done
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                connection.Open();
        ...
        public  DataSet ExecuteDataset(SqlConnection connection, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            ...
            using (SqlDataAdapter da = new SqlDataAdapter(cmd))
            {
                ...
                //if (DateTime.Now.Subtract(timeStart).TotalMilliseconds > 600)//测试数据库读取时间600ms
                //{
                //    LogHelper.LogHelper.WriteLog("WRN", "DBO", "SQLHelper", "ExecuteDataset", "数据库查询时间超过600ms。耗时：" + DateTime.Now.Subtract(timeStart).TotalMilliseconds + "ms", null);
                //}
                // Return the dataset
                return ds;
            }
        ...
        { 
            ...
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
                ...
                // Call the overload that takes an array of SqlParameters
                return ExecuteScalar(_ConnectionStr, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                // Otherwise we can just call the SP without params
                return ExecuteScalar(_ConnectionStr, CommandType.StoredProcedure, spName);
            }
        }
        ...
        public  object ExecuteScalar(SqlConnection connection, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
           ...
           // if (connection == null) throw new ArgumentNullException("connection");
            ...
            //if (DateTime.Now.Subtract(timeStart).TotalMilliseconds > 600)//测试数据库读取时间600ms
            //{
            //    LogHelper.LogHelper.WriteLog("WRN", "DBO", "SQLHelper", "ExecuteScalar", "数据库查询时间超过600ms。耗时：" + DateTime.Now.Subtract(timeStart).TotalMilliseconds + "ms", null);
            //}
            return retval;
        }
        ...
        public  DataTable ExecuteDataTable(string connectionString, CommandType commandType, string commandText)
        {
            ...
            //if (DateTime.Now.Subtract(timeStart).TotalMilliseconds > 600)//测试数据库读取时间600ms
            //{
            //    LogHelper.LogHelper.WriteLog("WRN", "DBO", "SQLHelper", "ExecuteDataTable", "数据库查询时间超过600ms。耗时：" + DateTime.Now.Subtract(timeStart).TotalMilliseconds + "ms", null);
            //}
        ...
        { 
            DataSet ds = ExecuteDataSet(_ConnectionStr, commandType, commandText, commandParameters);
            //if (DateTime.Now.Subtract(timeStart).TotalMilliseconds > 600)//测试数据库读取时间600ms
            //{
            //    LogHelper.LogHelper.WriteLog("WRN", "DBO", "SQLHelper", "ExecuteDataTable", "数据库查询时间超过600ms。耗时：" + DateTime.Now.Subtract(timeStart).TotalMilliseconds + "ms", null);
            //}
        ...
        {
            //DateTime timeStart = DateTime.Now;
            if (connectionString == null) { connectionString = _ConnectionStr; }
        ...
        { 
            //DateTime timeStart = DateTime.Now;
            DataTable dt = ExecuteDataTable(_ConnectionStr, commandType, commandText);
            //if (DateTime.Now.Subtract(timeStart).TotalMilliseconds > 600)//测试数据库读取时间600ms
            //{
            //    LogHelper.LogHelper.WriteLog("WRN", "DBO", "SQLHelper", "ExecuteDataRow", "数据库查询时间超过600ms。耗时：" + DateTime.Now.Subtract(timeStart).TotalMilliseconds + "ms", null);
            //}
            if (dt == null)
            {
                return null;
        ...
        {
            //DateTime timeStart = DateTime.Now; 
            DataTable dt = ExecuteDataTable(_ConnectionStr, commandType, commandText, commandParameters);
            //if (DateTime.Now.Subtract(timeStart).TotalMilliseconds>1000)//测试数据库读取时间1000ms
            //{
            //    LogHelper.LogHelper.WriteLog("WRN", "DBO", "SQLHelper", "ExecuteDataRow", "数据库查询时间超过1000ms。耗时："+DateTime.Now.Subtract(timeStart).TotalMilliseconds+"ms", null);
            //}
            if (dt == null)
            {
                return null;
        ...
        /// <param name="commandParameters"></param>
        /// <returns></returns>
        public  DataRow ExecuteDataRow(string connectionString ,CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            //DateTime timeStart = DateTime.Now; 
        ...
        #region ExecuteDataField

        public  string ExecuteDataField(CommandType commandType, string commandText)
        {

            DataRow dr = ExecuteDataRow(commandType, commandText);
            if (dr == null)
            {
                return null;
            }
        ...
        public  string ExecuteDataField(CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            DataRow dr = ExecuteDataRow(commandType, commandText, commandParameters);
            if (dr == null)
            {
                return null;
            }
        ...
        public  bool ExecuteBoolDataField(CommandType commandType, string commandText)
        {
            DataRow dr = ExecuteDataRow(commandType, commandText);
            if (dr == null)
            {
        ...
        public  bool ExecuteBoolDataField(CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            DataRow dr = ExecuteDataRow(commandType, commandText, commandParameters);
            if (dr == null)
            {
        ...
        public  int ExecuteIntDataField(CommandType commandType, string commandText)
        {
            DataRow dr = ExecuteDataRow(commandType, commandText);
            if (dr == null)
            {
        ...
        public  int ExecuteInt(string connectionString,CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            DataRow dr = ExecuteDataRow(connectionString,commandType, commandText, commandParameters);
            if (dr == null)
            {
                return 0;
            }
        ...
        public  long ExecuteLongDataField(CommandType commandType, string commandText)
        {
            DataRow dr = ExecuteDataRow(commandType, commandText);
            if (dr == null)
            {
        ...
        public  long ExecuteLongDataField(CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            DataRow dr = ExecuteDataRow(commandType, commandText, commandParameters);
            if (dr == null)
            {
        ...
        public  DateTime ExecuteDateTimeDataField(CommandType commandType, string commandText)
        {
            DataRow dr = ExecuteDataRow(commandType, commandText);
            if (dr == null)
            {
                return DateTime.Parse("2005-1-1");
            }
            else
            {
        ...
        public  DateTime ExecuteDateTimeDataField(CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            DataRow dr = ExecuteDataRow(commandType, commandText, commandParameters);
            if (dr == null)
            {
        ...
        public  byte ExecuteTinyIntDataField(CommandType commandType, string commandText)
        {
            DataRow dr = ExecuteDataRow(commandType, commandText);
            if (dr == null)
            {
        ...
        public  byte ExecuteTinyIntDataField(CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            DataRow dr = ExecuteDataRow(commandType, commandText, commandParameters);
            if (dr == null)
            {
        ...
        public  XmlReader ExecuteXmlReader(SqlConnection connection, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            ...
            try
            {
                ...
                //if (DateTime.Now.Subtract(timeStart).TotalMilliseconds > 600)//测试数据库读取时间600ms
                //{
                //    LogHelper.LogHelper.WriteLog("WRN", "DBO", "SQLHelper", "ExecuteXmlReader", "数据库查询时间超过600ms。耗时：" + DateTime.Now.Subtract(timeStart).TotalMilliseconds + "ms", null);
                //}
                return retval;
            }
            catch
        ...
        public  SqlTransaction BeginTransaction(string con)
        {
        ...
        //public  void ExecuteNonQuery(string p, CommandType commandType, string p_3, SqlParameter[] paramArray)
        //{
    ...
    internal sealed class SqlHelperParameterCache
    {
        ...
        private  SqlParameter[] DiscoverSpParameterSet(SqlConnection connection, string spName, bool includeReturnValueParameter)
        {
            if (connection == null) throw new ArgumentNullException("connection");
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
        ...
        /// <param name="includeReturnValueParameter">A bool value indicating whether the return value parameter should be included in the results</param>
        /// <returns>An array of SqlParameters</returns>
        internal  SqlParameter[] GetSpParameterSet(SqlConnection connection, string spName, bool includeReturnValueParameter)
        {
            if (connection == null) throw new ArgumentNullException("connection");
